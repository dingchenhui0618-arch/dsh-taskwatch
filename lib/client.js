  ...
  factory: function (require) {
    ...
    function useSnapshot() {
      ...
      React.useEffect(function () {
        var alive = true
        function tick() {
          fetch('/taskwatch/data', { cache: 'no-store' }).then(function (r) {
            return r.json()
          }).then(function (value) {
            if (alive) { setSnap(value); setErr(null) }
          }, function (e) {
        ...
        return function () { alive = false; clearInterval(handle) }
      }, [])
      return [snap, err]
    }
    ...
    function Panel() {
      ...
      if (err) {
        return React.createElement('div', { className: 'tw-wrap' },
          React.createElement('div', { className: 'tw-card err' },
            ...
            React.createElement('div', { className: 'tw-dim' }, '\u8bfb\u53d6\u5931\u8d25\uff1a' + err)))
      }
      if (!snap) {
        return React.createElement('div', { className: 'tw-wrap' },
      ...
      return React.createElement('div', { className: 'tw-wrap' },
        React.createElement('div', { className: 'tw-top' },
          ...
          React.createElement('span', { className: 'tw-meta' }, new Date(now).toLocaleTimeString() + ' \u00b7 \u6bcf 3 \u79d2\u5237\u65b0')),
        sections)
    }
